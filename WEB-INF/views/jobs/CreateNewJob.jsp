  ...
  <jsp:body>
    ...
    <section class="max-w-xl m-auto mt-5">
      <form method="POST" action="/create-new-job">
        <div class="mb-4">
          <input name="title" type="text" placeholder="Title of Job" title="Title of Job"
        ...
        <div class="mb-4">
          <textarea name="description" rows="8" cols="50" placeholder="Detailed job description. You can use HTML for rich formatting." title="Description"
            class="shadow appearance-none border w-full py-2 px-3"></textarea>
        </div>
        <div class="mb-4">
          <input name="salary" type="number" placeholder="Salary (yearly)" title="Salary"
        ...
        <div class="mb-4">
          <input name="location" type="text" placeholder="Location (office address or Remote)" title="Location"
            class="shadow appearance-none border w-full py-2 px-3" />
        </div>
